...
*/var ns,jC;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,v){function C(){}C.prototype=v.prototype,I.D=v.prototype,I.prototype=new C,I.prototype.constructor=I,I.C=function(w,x,N){for(var k=Array(arguments.length-2),rt=2;rt<arguments.length;rt++)k[rt-2]=arguments[rt];return v.prototype[x].apply(w,k)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(I,v,C){C||(C=0);var w=Array(16);if(typeof v=="string")for(var x=0;16>x;++x)w[x]=v.charCodeAt(C++)|v.charCodeAt(C++)<<8|v.charCodeAt(C++)<<16|v.charCodeAt(C++)<<24;else for(x=0;16>x;++x)w[x]=v[C++]|v[C++]<<8|v[C++]<<16|v[C++]<<24;v=I.g[0],C=I.g[1],x=I.g[2];var N=I.g[3],k=v+(N^C&(x^N))+w[0]+3614090360&4294967295;v=C+(k<<7&4294967295|k>>>25),k=N+(x^v&(C^x))+w[1]+3905402710&4294967295,N=v+(k<<12&4294967295|k>>>20),k=x+(C^N&(v^C))+w[2]+606105819&4294967295,x=N+(k<<17&4294967295|k>>>15),k=C+(v^x&(N^v))+w[3]+3250441966&4294967295,C=x+(k<<22&4294967295|k>>>10),k=v+(N^C&(x^N))+w[4]+4118548399&4294967295,v=C+(k<<7&4294967295|k>>>25),k=N+(x^v&(C^x))+w[5]+1200080426&4294967295,N=v+(k<<12&4294967295|k>>>20),k=x+(C^N&(v^C))+w[6]+2821735955&4294967295,x=N+(k<<17&4294967295|k>>>15),k=C+(v^x&(N^v))+w[7]+4249261313&4294967295,C=x+(k<<22&4294967295|k>>>10),k=v+(N^C&(x^N))+w[8]+1770035416&4294967295,v=C+(k<<7&4294967295|k>>>25),k=N+(x^v&(C^x))+w[9]+2336552879&4294967295,N=v+(k<<12&4294967295|k>>>20),k=x+(C^N&(v^C))+w[10]+4294925233&4294967295,x=N+(k<<17&4294967295|k>>>15),k=C+(v^x&(N^v))+w[11]+2304563134&4294967295,C=x+(k<<22&4294967295|k>>>10),k=v+(N^C&(x^N))+w[12]+1804603682&4294967295,v=C+(k<<7&4294967295|k>>>25),k=N+(x^v&(C^x))+w[13]+4254626195&4294967295,N=v+(k<<12&4294967295|k>>>20),k=x+(C^N&(v^C))+w[14]+2792965006&4294967295,x=N+(k<<17&4294967295|k>>>15),k=C+(v^x&(N^v))+w[15]+1236535329&4294967295,C=x+(k<<22&4294967295|k>>>10),k=v+(x^N&(C^x))+w[1]+4129170786&4294967295,v=C+(k<<5&4294967295|k>>>27),k=N+(C^x&(v^C))+w[6]+3225465664&4294967295,N=v+(k<<9&4294967295|k>>>23),k=x+(v^C&(N^v))+w[11]+643717713&4294967295,x=N+(k<<14&4294967295|k>>>18),k=C+(N^v&(x^N))+w[0]+3921069994&4294967295,C=x+(k<<20&4294967295|k>>>12),k=v+(x^N&(C^x))+w[5]+3593408605&4294967295,v=C+(k<<5&4294967295|k>>>27),k=N+(C^x&(v^C))+w[10]+38016083&4294967295,N=v+(k<<9&4294967295|k>>>23),k=x+(v^C&(N^v))+w[15]+3634488961&4294967295,x=N+(k<<14&4294967295|k>>>18),k=C+(N^v&(x^N))+w[4]+3889429448&4294967295,C=x+(k<<20&4294967295|k>>>12),k=v+(x^N&(C^x))+w[9]+568446438&4294967295,v=C+(k<<5&4294967295|k>>>27),k=N+(C^x&(v^C))+w[14]+3275163606&4294967295,N=v+(k<<9&4294967295|k>>>23),k=x+(v^C&(N^v))+w[3]+4107603335&4294967295,x=N+(k<<14&4294967295|k>>>18),k=C+(N^v&(x^N))+w[8]+1163531501&4294967295,C=x+(k<<20&4294967295|k>>>12),k=v+(x^N&(C^x))+w[13]+2850285829&4294967295,v=C+(k<<5&4294967295|k>>>27),k=N+(C^x&(v^C))+w[2]+4243563512&4294967295,N=v+(k<<9&4294967295|k>>>23),k=x+(v^C&(N^v))+w[7]+1735328473&4294967295,x=N+(k<<14&4294967295|k>>>18),k=C+(N^v&(x^N))+w[12]+2368359562&4294967295,C=x+(k<<20&4294967295|k>>>12),k=v+(C^x^N)+w[5]+4294588738&4294967295,v=C+(k<<4&4294967295|k>>>28),k=N+(v^C^x)+w[8]+2272392833&4294967295,N=v+(k<<11&4294967295|k>>>21),k=x+(N^v^C)+w[11]+1839030562&4294967295,x=N+(k<<16&4294967295|k>>>16),k=C+(x^N^v)+w[14]+4259657740&4294967295,C=x+(k<<23&4294967295|k>>>9),k=v+(C^x^N)+w[1]+2763975236&4294967295,v=C+(k<<4&4294967295|k>>>28),k=N+(v^C^x)+w[4]+1272893353&4294967295,N=v+(k<<11&4294967295|k>>>21),k=x+(N^v^C)+w[7]+4139469664&4294967295,x=N+(k<<16&4294967295|k>>>16),k=C+(x^N^v)+w[10]+3200236656&4294967295,C=x+(k<<23&4294967295|k>>>9),k=v+(C^x^N)+w[13]+681279174&4294967295,v=C+(k<<4&4294967295|k>>>28),k=N+(v^C^x)+w[0]+3936430074&4294967295,N=v+(k<<11&4294967295|k>>>21),k=x+(N^v^C)+w[3]+3572445317&4294967295,x=N+(k<<16&4294967295|k>>>16),k=C+(x^N^v)+w[6]+76029189&4294967295,C=x+(k<<23&4294967295|k>>>9),k=v+(C^x^N)+w[9]+3654602809&4294967295,v=C+(k<<4&4294967295|k>>>28),k=N+(v^C^x)+w[12]+3873151461&4294967295,N=v+(k<<11&4294967295|k>>>21),k=x+(N^v^C)+w[15]+530742520&4294967295,x=N+(k<<16&4294967295|k>>>16),k=C+(x^N^v)+w[2]+3299628645&4294967295,C=x+(k<<23&4294967295|k>>>9),k=v+(x^(C|~N))+w[0]+4096336452&4294967295,v=C+(k<<6&4294967295|k>>>26),k=N+(C^(v|~x))+w[7]+1126891415&4294967295,N=v+(k<<10&4294967295|k>>>22),k=x+(v^(N|~C))+w[14]+2878612391&4294967295,x=N+(k<<15&4294967295|k>>>17),k=C+(N^(x|~v))+w[5]+4237533241&4294967295,C=x+(k<<21&4294967295|k>>>11),k=v+(x^(C|~N))+w[12]+1700485571&4294967295,v=C+(k<<6&4294967295|k>>>26),k=N+(C^(v|~x))+w[3]+2399980690&4294967295,N=v+(k<<10&4294967295|k>>>22),k=x+(v^(N|~C))+w[10]+4293915773&4294967295,x=N+(k<<15&4294967295|k>>>17),k=C+(N^(x|~v))+w[1]+2240044497&4294967295,C=x+(k<<21&4294967295|k>>>11),k=v+(x^(C|~N))+w[8]+1873313359&4294967295,v=C+(k<<6&4294967295|k>>>26),k=N+(C^(v|~x))+w[15]+4264355552&4294967295,N=v+(k<<10&4294967295|k>>>22),k=x+(v^(N|~C))+w[6]+2734768916&4294967295,x=N+(k<<15&4294967295|k>>>17),k=C+(N^(x|~v))+w[13]+1309151649&4294967295,C=x+(k<<21&4294967295|k>>>11),k=v+(x^(C|~N))+w[4]+4149444226&4294967295,v=C+(k<<6&4294967295|k>>>26),k=N+(C^(v|~x))+w[11]+3174756917&4294967295,N=v+(k<<10&4294967295|k>>>22),k=x+(v^(N|~C))+w[2]+718787259&4294967295,x=N+(k<<15&4294967295|k>>>17),k=C+(N^(x|~v))+w[9]+3951481745&4294967295,I.g[0]=I.g[0]+v&4294967295,I.g[1]=I.g[1]+(x+(k<<21&4294967295|k>>>11))&4294967295,I.g[2]=I.g[2]+x&4294967295,I.g[3]=I.g[3]+N&4294967295}r.prototype.u=function(I,v){v===void 0&&(v=I.length);for(var C=v-this.blockSize,w=this.B,x=this.h,N=0;N<v;){if(x==0)for(;N<=C;)i(this,I,N),N+=this.blockSize;if(typeof I=="string"){for(;N<v;)if(w[x++]=I.charCodeAt(N++),x==this.blockSize){i(this,w),x=0;break}}else for(;N<v;)if(w[x++]=I[N++],x==this.blockSize){i(this,w),x=0;break}}this.h=x,this.o+=v},r.prototype.v=function(){var I=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);I[0]=128;for(var v=1;v<I.length-8;++v)I[v]=0;var C=8*this.o;for(v=I.length-8;v<I.length;++v)I[v]=C&255,C/=256;for(this.u(I),I=Array(16),v=C=0;4>v;++v)for(var w=0;32>w;w+=8)I[C++]=this.g[v]>>>w&255;return I};function s(I,v){var C=a;return Object.prototype.hasOwnProperty.call(C,I)?C[I]:C[I]=v(I)}function o(I,v){this.h=v;for(var C=[],w=!0,x=I.length-1;0<=x;x--){var N=I[x]|0;w&&N==v||(C[x]=N,w=!1)}this.g=C}var a={};function u(I){return-128<=I&&128>I?s(I,function(v){return new o([v|0],0>v?-1:0)}):new o([I|0],0>I?-1:0)}function c(I){if(isNaN(I)||!isFinite(I))return f;if(0>I)return P(c(-I));for(var v=[],C=1,w=0;I>=C;w++)v[w]=I/C|0,C*=4294967296;return new o(v,0)}function h(I,v){if(I.length==0)throw Error("number format error: empty string");if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(I.charAt(0)=="-")return P(h(I.substring(1),v));if(0<=I.indexOf("-"))throw Error('number format error: interior "-" character');for(var C=c(Math.pow(v,8)),w=f,x=0;x<I.length;x+=8){var N=Math.min(8,I.length-x),k=parseInt(I.substring(x,x+N),v);8>N?(N=c(Math.pow(v,N)),w=w.j(N).add(c(k))):(w=w.j(C),w=w.add(c(k)))}return w}var f=u(0),p=u(1),_=u(16777216);t=o.prototype,t.m=function(){if(R(this))return-P(this).m();for(var I=0,v=1,C=0;C<this.g.length;C++){var w=this.i(C);I+=(0<=w?w:4294967296+w)*v,v*=4294967296}return I},t.toString=function(I){if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(T(this))return"0";if(R(this))return"-"+P(this).toString(I);for(var v=c(Math.pow(I,6)),C=this,w="";;){var x=O(C,v).g;C=S(C,x.j(v));var N=((0<C.g.length?C.g[0]:C.h)>>>0).toString(I);if(C=x,T(C))return N+w;for(;6>N.length;)N="0"+N;w=N+w}},t.i=function(I){return 0>I?0:I<this.g.length?this.g[I]:this.h};function T(I){if(I.h!=0)return!1;for(var v=0;v<I.g.length;v++)if(I.g[v]!=0)return!1;return!0}function R(I){return I.h==-1}t.l=function(I){return I=S(this,I),R(I)?-1:T(I)?0:1};function P(I){for(var v=I.g.length,C=[],w=0;w<v;w++)C[w]=~I.g[w];return new o(C,~I.h).add(p)}t.abs=function(){return R(this)?P(this):this},t.add=function(I){for(var v=Math.max(this.g.length,I.g.length),C=[],w=0,x=0;x<=v;x++){var N=w+(this.i(x)&65535)+(I.i(x)&65535),k=(N>>>16)+(this.i(x)>>>16)+(I.i(x)>>>16);w=k>>>16,N&=65535,k&=65535,C[x]=k<<16|N}return new o(C,C[C.length-1]&-2147483648?-1:0)};function S(I,v){return I.add(P(v))}t.j=function(I){if(T(this)||T(I))return f;if(R(this))return R(I)?P(this).j(P(I)):P(P(this).j(I));if(R(I))return P(this.j(P(I)));if(0>this.l(_)&&0>I.l(_))return c(this.m()*I.m());for(var v=this.g.length+I.g.length,C=[],w=0;w<2*v;w++)C[w]=0;for(w=0;w<this.g.length;w++)for(var x=0;x<I.g.length;x++){var N=this.i(w)>>>16,k=this.i(w)&65535,rt=I.i(x)>>>16,Wt=I.i(x)&65535;C[2*w+2*x]+=k*Wt,E(C,2*w+2*x),C[2*w+2*x+1]+=N*Wt,E(C,2*w+2*x+1),C[2*w+2*x+1]+=k*rt,E(C,2*w+2*x+1),C[2*w+2*x+2]+=N*rt,E(C,2*w+2*x+2)}for(w=0;w<v;w++)C[w]=C[2*w+1]<<16|C[2*w];for(w=v;w<2*v;w++)C[w]=0;return new o(C,0)};function E(I,v){for(;(I[v]&65535)!=I[v];)I[v+1]+=I[v]>>>16,I[v]&=65535,v++}function A(I,v){this.g=I,this.h=v}function O(I,v){if(T(v))throw Error("division by zero");if(T(I))return new A(f,f);if(R(I))return v=O(P(I),v),new A(P(v.g),P(v.h));if(R(v))return v=O(I,P(v)),new A(P(v.g),v.h);if(30<I.g.length){if(R(I)||R(v))throw Error("slowDivide_ only works with positive integers.");for(var C=p,w=v;0>=w.l(I);)C=V(C),w=V(w);var x=U(C,1),N=U(w,1);for(w=U(w,2),C=U(C,2);!T(w);){var k=N.add(w);0>=k.l(I)&&(x=x.add(C),N=k),w=U(w,1),C=U(C,1)}return v=S(I,x.j(v)),new A(x,v)}for(x=f;0<=I.l(v);){for(C=Math.max(1,Math.floor(I.m()/v.m())),w=Math.ceil(Math.log(C)/Math.LN2),w=48>=w?1:Math.pow(2,w-48),N=c(C),k=N.j(v);R(k)||0<k.l(I);)C-=w,N=c(C),k=N.j(v);T(N)&&(N=p),x=x.add(N),I=S(I,k)}return new A(x,I)}t.A=function(I){return O(this,I).h},t.and=function(I){for(var v=Math.max(this.g.length,I.g.length),C=[],w=0;w<v;w++)C[w]=this.i(w)&I.i(w);return new o(C,this.h&I.h)},t.or=function(I){for(var v=Math.max(this.g.length,I.g.length),C=[],w=0;w<v;w++)C[w]=this.i(w)|I.i(w);return new o(C,this.h|I.h)},t.xor=function(I){for(var v=Math.max(this.g.length,I.g.length),C=[],w=0;w<v;w++)C[w]=this.i(w)^I.i(w);return new o(C,this.h^I.h)};function V(I){for(var v=I.g.length+1,C=[],w=0;w<v;w++)C[w]=I.i(w)<<1|I.i(w-1)>>>31;return new o(C,I.h)}function U(I,v){var C=v>>5;v%=32;for(var w=I.g.length-C,x=[],N=0;N<w;N++)x[N]=0<v?I.i(N+C)>>>v|I.i(N+C+1)<<32-v:I.i(N+C);return new o(x,I.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,jC=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=h,ns=o}).apply(typeof PE<"u"?PE:typeof self<"u"?self:typeof window<"u"?window:{});var cc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XF=Math.log(2);class JF{constructor(e){const n=s=>parseInt(Math.log(s)/XF,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const bh=function(t,e,n,r){t.sort(e);const i=function(u,c){const h=c-u;let f,p;if(h===0)return null;if(h===1)return f=t[u],p=n?n(f):f,new at(p,f.node,at.BLACK,null,null);{const _=parseInt(h/2,10)+u,T=i(u,_),R=i(_+1,c);return f=t[_],p=n?n(f):f,new at(p,f.node,at.BLACK,T,R)}},s=function(u){let c=null,h=null,f=t.length;const p=function(T,R){const P=f-T,S=f;f-=T;const E=i(P+1,S),A=t[P],O=n?n(A):A;_(new at(O,A.node,R,null,E))},_=function(T){c?(c.left=T,c=T):(h=T,c=T)};for(let T=0;T<u.count;++T){const R=u.nextBitIsOne(),P=Math.pow(2,u.count-(T+1));R?p(P,at.BLACK):(p(P,at.BLACK),p(P,at.RED))}return h},o=new JF(t.length),a=s(o);return new Kt(r||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
